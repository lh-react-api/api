...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('demands', function (Blueprint $table) {
            ...
            $table->string('last_name', 128)->comment(__('db.demands.last_name'));
            $table->string('last_name_kana', 128)->comment(__('db.demands.last_name_kana'));
            $table->string('first_name', 128)->comment(__('db.demands.first_name'));
            $table->string('first_name_kana', 128)->comment(__('db.demands.first_name_kana'));
