...
class AddressPolicy extends BasePolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function adminView(User $user, Address $address)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function adminCreate(User $user, Address $address)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function adminUpdate(User $user, Address $address)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function adminDelete(User $user, Address $address)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function adminRestore(User $user, Address $address)
    {
        $this->byAdminAuthUser(AdminAuthoritiesAction::UPDATE);
        return true;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function adminForceDelete(User $user, Address $address)
    {
        $this->byAdminAuthUser(AdminAuthoritiesAction::DELETE);
        return true;
    }
