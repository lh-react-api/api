...
class Show_old extends BaseController
{
    /**
    ...
    public function __invoke(Request $request, int $id)
    {
        ...
        $model->productReviewNumbers = [
            1 => $model->productReviews->whereIn('evaluation', [1,2])->count(),
            2 => $model->productReviews->whereIn('evaluation', [3,4])->count(),
            3 => $model->productReviews->whereIn('evaluation', [5,6])->count(),
            4 => $model->productReviews->whereIn('evaluation', [7,8])->count(),
            5 => $model->productReviews->whereIn('evaluation', [9,10])->count()
        ];
